...
class HooksExecuter {
  ...
  component() {
    const EmptyComponent = () => {
      Object.values(this.__hooks).forEach(({ name, hook, isApollo }) =>
        this.putHooks(name, isApollo ? hook : hook())
      );
      return <Fragment />;
    };
